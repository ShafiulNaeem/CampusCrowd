              ...
              <div class="card text-white bg-primary">
                ...
                <div class="chart-wrapper mt-3 mx-3" style="height:70px;">
                  ...
                  <canvas
                    ...
                    height="70"
                    width="146"
                    style="display: block; width: 146px; height: 70px;"
                  ></canvas>
                </div>
              </div>
            </div>
              ...
              <div class="card text-white bg-warning">
                ...
                <div class="chart-wrapper mt-3" style="height:70px;">
                  ...
                  <canvas
                    ...
                    height="70"
                    width="178"
                    style="display: block; width: 178px; height: 70px;"
                  ></canvas>
                </div>
              </div>
            </div>
            ...
            <div class="card-body">
              ...
              <div class="chart-wrapper" style="height:300px;margin-top:40px;">
                ...
                <canvas
                  ...
                  height="300"
                  width="768"
                  style="display: block; width: 768px; height: 300px;"
                ></canvas>
              </div>
            </div>
                ...
                <div class="brand-card-header bg-facebook">
                  ...
                  <div class="chart-wrapper">
                    ...
                    <canvas
                      ...
                      style="display: block; width: 178px; height: 96px;"
                    ></canvas>
                  </div>
                </div>
